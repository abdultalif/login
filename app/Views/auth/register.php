                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="<?= route_to('register') ?>" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user <?php if (session('errors.email')) : ?>is-invalid<?php endif ?>" name="username" placeholder="<?= lang('Auth.username') ?>" value="<?= old('username') ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <hr>
                            <div class="text-center">
                                <a href="<?= route_to('login') ?>" class="small"><?= lang('Auth.alreadyRegistered') ?> <?= lang('Auth.signIn') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
